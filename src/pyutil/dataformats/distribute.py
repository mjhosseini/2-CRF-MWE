...
'''
Allocates source dataAnalyzer into batches. Intended for several scenarios, including
partitioning dataAnalyzer into train/dev/test splits, and distributing dataAnalyzer for annotation
...
parser.add_argument('inputFile', nargs='+', help="input dataAnalyzer")
...
def items():
    '''Generator over items of input dataAnalyzer, as determined by options.'''
