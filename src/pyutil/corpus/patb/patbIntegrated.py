...
if os.path.isdir('/mal2/corpora'):
    ...
    PATB_3_DIR = 'edu/cmu/cs/lti/aqmar/dataAnalyzer/ATB3-v3.2-sample'
...
def fileids():
    return list(map(lambda filename: filename[:-4], 
               futil.list_files(PATB_3_DIR + '/dataAnalyzer/integrated', r'.*[.]txt$', recursive=False, absolute=False)))

def getDocPath(fileid):
    return PATB_3_DIR + '/dataAnalyzer/integrated/{0}.txt'.format(fileid)
